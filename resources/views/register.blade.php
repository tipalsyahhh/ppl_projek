    ...
    <div class="card-body">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="namabelakang" class="form-control" value="{{ old('namabelakang') }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="remember_token" value="{{ substr(str_shuffle('0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'), 0, 60) }}">
            </div>
            <div class="form-group">
